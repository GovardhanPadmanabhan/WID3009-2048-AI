...
import pacman.entries.pacman.MinimaxPacman;
...
//		System.out.println("MiniMaxPacman vs LEGACY2THERECKONING");
//		exec.runGame(new MinimaxPacman(new Legacy2TheReckoning(), 5), new Legacy2TheReckoning(), visual,delay);		
		
		System.out.println("MiniMaxPacman vs AggressiveGhosts");
		exec.runGame(new MinimaxPacman(new AggressiveGhosts(), 5), new AggressiveGhosts(), visual,delay);
		
//		System.out.println("MiniMaxPacman vs RandomGhosts");		
//		exec.runGame(new MinimaxPacman(new StarterGhosts(), 5), new StarterGhosts(), visual,delay);	
		
		/* run multiple games in batch mode - good for testing. */
				
//		System.out.println("MiniMaxPacman vs Legacy2TheReckoning");
//		exec.runExperiment(new MinimaxPacman(new Legacy2TheReckoning(), 5),new Legacy2TheReckoning(), 10 );
		
//		System.out.println("MiniMaxPacman vs AggressiveGhosts");
//		exec.runExperiment(new MinimaxPacman(new AggressiveGhosts(), 5), new AggressiveGhosts(), 20 );
		
//		System.out.println("MiniMaxPacman vs RandomGhosts");		
//		exec.runExperiment(new MinimaxPacman(new StarterGhosts(), 5), new StarterGhosts(), 20 );
