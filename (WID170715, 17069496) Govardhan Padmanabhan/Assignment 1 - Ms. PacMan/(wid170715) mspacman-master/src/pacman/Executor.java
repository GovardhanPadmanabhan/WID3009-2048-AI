...
//		exec.runGame(new StarterPacMan(), new AggressiveGhosts(), visual, delay);
//		exec.runExperiment(new StarterPacMan(), new AggressiveGhosts(), numTrials);
		
		
		// demonstrating my implementation
//		System.out.println("MY IMPLEMENTATION vs AGGRESSIVE GHOSTS");
//		exec.runGame(new WID170715_MCTS(), new AggressiveGhosts(), visual, delay);
//		exec.runExperiment(new WID170715_MCTS(), new AggressiveGhosts(), numTrials);
		
		
		// demonstrating one of the winning strategies
		System.out.println("ICEP-IDDFS");
		exec.runGame(new ICEP_IDDFS(), new AggressiveGhosts(), visual, delay);
...
//		System.out.println("MY IMPLEMENTATION vs AGGRESSIVE GHOSTS");
//		exec.runGame(new MyPacMan(), new Legacy2TheReckoning(), visual,delay);
